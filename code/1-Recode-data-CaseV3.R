...
progres.case$CountryAsylum <- "MAU"
...
write.csv(progres.case, file = "data/data.csv",na="", row.names = FALSE)
...
library(readxl)
SpecificNeedsCodesV2 <- read_excel("data/SpecificNeedsCodesV2.xlsx",    sheet = "Revised")
names(SpecificNeedsCodesV2)

## Extract from DWH
progres.specificneed <- read.csv("data/progresspecificneed.csv")
progres.specificneed <- progres.specificneed[,c("CaseNo","code")]

#summary(progres.specificneed)
names(progres.specificneed)

## Check if duplicates
progres.specificneed.unique <- unique(progres.specificneed[,c("CaseNo","code")])
...
###################################################
#names(progres.case.sp)
write.csv(progres.case.sp, file = "data/data.csv",na="", row.names = FALSE)
